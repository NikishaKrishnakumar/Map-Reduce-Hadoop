...
// 	          word.set(token);
 	      ...
 	      String yr = tokens[15]; // to get the year
 	      String model = tokens[3];  // to get the model details
 	      String cause_recall = tokens[6]; // to get the reason for the recall
 	      
 	       if (model!=null && cause_recall!= null) // initial validations
 	      {
...
*/
 	       {	  
 	    	  ...
 	    	  String total= "Year: " + yrs+ " ; Model: " + model+ " ; Cause for Recall: "+cause_recall; 
			  // formatting for printing the output
